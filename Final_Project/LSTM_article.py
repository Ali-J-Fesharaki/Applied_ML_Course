...
for k in range(1, num_steps+1):
    ...
    hat_Xi_V = lstm_output_V
    hat_Xi_G = lstm_output_G
    hat_Xi_F = lstm_output_F
    hat_Xi_M = lstm_output_M
    ...
    # Adaptation Law
    Xi_M_prim = Theta_hat_prim_M
    Xi_V_prim = Theta_hat_prim_V
    Xi_G_prim =Theta_hat_prim_G
